                    ...
                    children: List.generate(_moodEmojis.length, (index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(_moodEmojis[index], style: const TextStyle(fontSize: 24)),
                        ),
                      );
                    }),
                  ),
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Text('Экстренная помощь', style: TextStyle(fontSize: 16)),
                        ],
                      ),
                    ),
                  ),
                          ...
                          child: LineChart(
                            LineChartData(
                              lineBarsData: [
                                LineChartBarData(
                                  spots: const [
                                    FlSpot(0, 3), FlSpot(1, 4), FlSpot(2, 2),
                                    FlSpot(3, 5), FlSpot(4, 3), FlSpot(5, 4), FlSpot(6, 4),
                                  ],
                                  isCurved: true,
                                  color: AppColors.primaryBlue,
                                  barWidth: 3,
